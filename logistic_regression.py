...
def do_experiments(start, end, step_num):
    ...
    for i, distance in enumerate(shift_distances, 1):
        ...
        # Fit logistic regression and get parameters
        ...
        plt.plot(x_vals, slope * x_vals + intercept, color='green', linestyle='--', label='Decision Boundary')

        # Calculate margin width using 70% confidence contour distance
